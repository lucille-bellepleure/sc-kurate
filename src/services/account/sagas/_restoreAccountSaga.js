...
export default function* restoreAccountSaga(action) {
	...
	const swarmUser = yield window.fds.Account.SwarmStore.SF.set(userObject.address, 'userdata', userObject.privateKey, {
