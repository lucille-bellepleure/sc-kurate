...
const RemoveAccount = ({ nextStage, removeAccount }) => (
	<div className={createAccount.containerred}>
		<div className={createAccount.title}>Do you want to remove your account?</div>
		...
		<div className={createAccount.dialogiconbox}>
			<div className={[styles.iconbuttonbig, createAccount.cancel].join(' ')} onClick={nextStage}>
				<div className={styles.xmarkicon} />
			</div>
			<div className={[styles.iconbuttonbig, createAccount.confirm].join(' ')} onClick={removeAccount}>
