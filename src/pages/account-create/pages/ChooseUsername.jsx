...
const ChooseUsername = ({ nextStage, exitStage, avatarStage, username, setUsername, avatar }) => (
	<div className={createAccount.formcontainer}>
		<div className={createAccount.closeButton} onClick={exitStage}>
			<div className={styles.exitgrayicon} />
		</div>
		<div className={createAccount.formtitle}>Choose an avatar and a username.</div>
