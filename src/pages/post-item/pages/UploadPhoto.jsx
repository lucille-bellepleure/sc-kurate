...
import Placeholder from "../../../images/-examplePhoto.jpg";
export function UploadPhoto({ nextStage, setPhoto }) {
  ...
  const processImage = () => {
    const photo = cropperRef.getCroppedCanvas().toDataURL();
    setPhoto(photo);
    nextStage();
  };
    ...
    <div className={main.container}>
      ...
      <div className={main.photoplace}>
        <Cropper
          ...
          viewMode={3}
          style={{ height: 400, width: "100%", margin: 0, padding: 0 }}
          aspectRatio={1 / 1}
          guides={true}
